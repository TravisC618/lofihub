...
const Register = (props) => {
    ...
    const [err, setErr] = useState({ type: "", msg: "" });
    ...
    const handleRegister = async () => {
        ...
        const formErr = registerValidation(form);
        if (formErr) {
            setErr(formErr);
            setIsLoading(false);
            return;
                ...
                <div className={classes.paper}>
                    ...
                    <form className={classes.form} noValidate>
                        <TextField
                            ...
                            helperText={err.type === "email" && err.msg}
                        />
                        <TextField
                            variant="outlined"
                            margin="normal"
                            ...
                            helperText={err.type === "username" && err.msg}
                        />
                        <TextField
                            variant="outlined"
                            margin="normal"
                        ...
                        {err.type === "accpet" && (
                            <FormHelperText className={classes.errMsg}>
                                You should accept this before going to next step
                            </FormHelperText>
                        )}
                        <Button
                            fullWidth
                        ...
                        <Grid container>
                            <Grid item xs>
                                <Link variant="body2">Privacy Policy</Link>
                            </Grid>
                            <Grid item>
